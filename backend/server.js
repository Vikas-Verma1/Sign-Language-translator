...
// ✅ ADDED: Root route so visiting the main URL shows a friendly message instead of "Cannot GET /"
app.get('/', (req, res) => {
  res.json({
...
// '0.0.0.0' ensures it listens on all network interfaces, which Render requires.
